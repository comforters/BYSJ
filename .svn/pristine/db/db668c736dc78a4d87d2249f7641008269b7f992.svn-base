...
import com.xx.ssm.dao.IAuthTreeDao;
...
@Service
public class AuthTreeServiceImpl implements IAuthTreeService {
	@Autowired
	private IAuthTreeDao authTreeDao;
	@Override
	...
	private List getTreeList(int id){
		List<TreeNode> nodes = authTreeDao.queryTreeNodes(id);
